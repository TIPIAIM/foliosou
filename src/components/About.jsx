  ...
  return (
    ...
    >
      <div className="max-w-screen-lg mx-auto px-6 py-10">
        ...
        {/* Content Section */}
        <div className="flex mt-8 flex-col md:flex-row items-center md:space-x-6 space-y-6 md:space-y-0">
          {/* Image Section */}
        ...
        <div className="flex mb-10 justify-center mt-10">
          <Link
            ...
            smooth
            duration={500}
            className="bg-gradient-to-r p-2 from-blue-100 via-green-500  flex items-center px-8 py-1  to-black text-white text-lg font-semibold rounded-md shadow-lg hover:scale-105 transition-transform duration-300 cursor-pointer"
          >
            Retour
            <FcLeft
              size={25}
